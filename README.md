...
| :--- | :--- | :--- | :--- |
| **LED 1 (Verde)** | GPIO 0 | **Segment A** | GPIO 18 |
| **LED 2 (Roșu)** | GPIO 16 | **Segment B** | GPIO 19 |
| **LED 3 (Avertizare)** | GPIO 17 | **Segment C** | GPIO 5 |
| **DIGIT 1** | GPIO 22 | **Segment D** | GPIO 15 |
| **DIGIT 2** | GPIO 23 | **Segment E** | GPIO 2 |
| **DP (Punct)** | GPIO 4 | **Segment F** | GPIO 21 |
| | | **Segment G** | GPIO 13 |
